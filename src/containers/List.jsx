...
class List extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            family: {
                name: "martinho",
                users: [{name: "marta", color: "blue"}, {name: "catarina", color: "green"}, {
                    name: "diogo",
                    color: "pink"
                }, {name: "martinho", color: "red"}]
            },
            lc: [{
                name: "Casa",
                icon: "casa",
                users: [{name: 'martinho', color: "red"}, {name: 'marta', color: "blue"}],
                produtos: [{name: "Maça", quant: "3 peças", desc: "maças amarelas"}, {
                    name: "Cogumelos",
                    quant: "3 latas",
                    desc: "cogumelos laminados"
                }]
            },
                {
                    name: "Trabalho",
                    icon: "trabalho",
                    users: [{name: 'martinho', color: "red"}, {name: 'catarina', color: "green"}, {
                        name: 'marta',
                        color: "blue"
                    }],
                    produtos: []
                            ...
                            <div className="row">
                                ...
                                <div className="col-xs-10 hamburguer">
                                    <a href="#" className="dropdown-toggle" data-toggle="dropdown"
                                       onClick={this.handleClick}><h3><b>Lista de Compras</b></h3> <span
                                        className="caret"></span></a>
                                    <ul className="dropdown-menu" role="menu">
                                        <li className="dropdown"><h3 className="dropownsize" onClick={this.handleModal}>
                                            <b>Nova Lista</b></h3></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
        ...
        if (this.state.showModal === true) {
            ...
            if (this.state.family.users.length === 2) {
                userslist = ( <div className="cc-selector">
                    <input id="user4" type="radio" name="user4" ref="user4" value={this.state.family.users[0].name}
                           checked={this.state.checkedu1}/>
                ...
                userslist = ( <div className="cc-selector">
                    <input id="user4" type="radio" name="user4" ref="user4" value={this.state.family.users[0].name}
                           checked={this.state.checkedu1}/>
                    <label className="user-cc btn-user4" For="user4" onClick={this.handleiconclicku1}></label>
                    <input id="user2" type="radio" name="user2" ref="user2" value={this.state.family.users[1].name}
                           checked={this.state.checkedu2}/>
                ...
                userslist = ( <div className="cc-selector">
                    ...
                    <input id="user2" type="radio" name="user2" ref="user2" value={this.state.family.users[1].name}
                           checked={this.state.checkedu2}/>
                    <label className="user-cc btn-user2" For="user2" onClick={this.handleiconclicku2}></label>
                    <input id="user3" type="radio" name="user3" ref="user3" value={this.state.family.users[2].name}
                           checked={this.state.checkedu3}/>
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                <button className="btn btn-default" onClick={this.handleModal}><span
